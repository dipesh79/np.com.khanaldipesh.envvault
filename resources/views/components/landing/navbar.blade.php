    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden items-center gap-3 md:flex">
                ...
                <a href="/app" class="inline-flex items-center justify-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Get Started
                </a>
            </div>
    ...
    >
        <div class="space-y-1 px-4 py-4">
            ...
            <div class="border-t border-slate-200 pt-4">
                <a href="/app" class="mt-2 block rounded-md bg-indigo-600 px-3 py-2 text-center text-base font-semibold text-white hover:bg-indigo-500">Get Started</a>
            </div>
        </div>
    </div>
</nav>